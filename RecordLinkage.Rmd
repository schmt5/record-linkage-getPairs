...
<span style="color:blue"><strong>False matches and false non-matches: </strong></span><br/>
...
Example: Martin and Mäddä: same person is meant, but the pair does not form a link
