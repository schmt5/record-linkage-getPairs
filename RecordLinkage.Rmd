...
head(rpairs) #overview of data rpairs
getPairs(rec.pairs, min.weight=0.5, max.weight=0.6) #all record pairs with weights between 0.5 and 0.6
...
summary(cldata$prediction)
getPairs(cldata, show="links", single.rows=FALSE) #now we can filter, show="links", "nonlinks", "possible" or "all"
```

<b>False matches and false non-matches</b>
<li>Synonym = </li>
<li>Homonym = </li>
